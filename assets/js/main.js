...
const sendEmail = (e) => {
    ...
    {
        (function(){
            emailjs.init("n5XZDtlCFxqAO6-Zo");
         })();
...
sr.reveal('.home__data, .about__container, .projects__container, .testimonial__container')
sr.reveal('.home__info div, .about__info',{delay:600, origin:'bottom', interval: 100})
sr.reveal('.skills__content, .contact__content:nth-child(1)',{origin:'left'})
sr.reveal('.skills__content:nth-child(2), .contact__content:nth-child(2)',{origin:'right'})
sr.reveal('qualification__contect, .services__card', {interval:100})
